...
import { Progress, Content, Image, Columns, Column, Box, Modal, ModalBackground, ModalClose, ModalContent } from 'bloomer';
...
class ContactForm extends Component {
  ...
  handleSubmit = e => {
    ...
    const uploaders = this.state.attachments.map(file => {
      ...
      return axios.post("https://api.cloudinary.com/v1_1/dx2sdr8wg/image/upload", formData, {
      ...
      <form onSubmit={this.handleSubmit}>
          ...
          <div className="field-body">
            <div className="field">
              <div className="control">
                <input className="input" type="text" placeholder="Normal sized input" value={this.state.name} onChange={this.handleChange} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="field is-horizontal">
          ...
          <div className="field-body">
            <div className="field">
              <div className="control">
                <FileUploader handleDrop={this.handleDrop} files={this.state.attachments}/>
              </div>
            </div>
          </div>
        </div>
